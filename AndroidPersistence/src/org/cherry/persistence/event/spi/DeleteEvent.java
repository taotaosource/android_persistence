...
public class DeleteEvent extends AbstractEvent {
	...
	// TODO: The removeOrphan concept is a temporary "hack" for HHH-6484. This
	// should be removed once action/task
	...
	public DeleteEvent(String entityName, Object object, boolean cascadeDeleteEnabled, boolean orphanRemovalBeforeUpdates,
			EventSource source) {
		this(object, source);
		this.entityName = entityName;
		this.cascadeDeleteEnabled = cascadeDeleteEnabled;
