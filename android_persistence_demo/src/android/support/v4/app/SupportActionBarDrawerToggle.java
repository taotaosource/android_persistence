 ...
 */
public class SupportActionBarDrawerToggle implements DrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link SupportActionBarDrawerToggle.Delegate} to use
    ...
    private static class ActionBarDrawerToggleImplBase implements ActionBarDrawerToggleImpl {
        ...
        public Object setActionBarUpIndicator(Object info, Activity activity,
        	...
        	if (activity instanceof ActionBarActivity) {
         		View view = activity.findViewById(android.support.v7.appcompat.R.id.home);
				ViewParent parent = view.getParent();
				ImageView home = (ImageView) ((View) parent).findViewById(R.id.up);
        		home.setImageDrawable(themeImage);
        	}
            return info;
        }
     ...
     *                                  for accessibility
     */
    public SupportActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,
